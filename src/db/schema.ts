...
export const equipment = pgTable("equipment", {
  ...
  warrantyPeriodNumber: integer("warranty_period_number"),
  warrantyPeriodUnit: text("warranty_period_unit"),
  warrantyExpiresOn: date("warranty_expires_on"),
  manualStatus: text("manual_status").notNull().default("Active"),
  recordType: text("record_type").notNull().default("Existing equipment recorded"),
  priceSoldCents: integer("price_sold_cents"),
  ...
  warrantyProvider: text("warranty_provider").notNull().default("Unknown"),
  warrantyNotes: text("warranty_notes"),
  warrantyClaimNotes: text("warranty_claim_notes"),
  serialNumberRequired: boolean("serial_number_required").notNull().default(false),
  internalNotes: text("internal_notes"),
  customerFacingNotes: text("customer_facing_notes"),
  serviceNotes: text("service_notes"),
  futureMaintenanceNotes: text("future_maintenance_notes"),
  evidenceChecklist: jsonb("evidence_checklist").$type<Record<string, unknown>[]>(),
  manualCustomerName: text("manual_customer_name"),
  manualCustomerContact: text("manual_customer_contact"),
...
export const reports = pgTable("reports", {
  ...
  reportDate: timestamp("report_date", { mode: "date" }),
